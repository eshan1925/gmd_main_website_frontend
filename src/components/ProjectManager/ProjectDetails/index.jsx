...
const ProjectDetails = () => {
    ...
    if (ProjectInfo.length === 0) {
        return (<center><h1>No projects created from the user</h1></center>)
    }
    else {
        ProjectInfo.forEach((data) => {
            ...
            const percentageOfProjectComplete = (completedTasks / numberOfTasks) * 100;
            finalElement.push(
                <div className={styles.projectInfo}>
                    ...
                    <div className={styles.projectDescription}>
                        <div className={styles.projectProgress}>
                            <CircularProgressbar value={percentageOfProjectComplete} text={`${percentageOfProjectComplete}%`} />
                        </div>

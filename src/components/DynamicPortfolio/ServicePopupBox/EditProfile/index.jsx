  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const url =
        ...
        ":8080/dynamicPortfolio/services/" +
        userData._id ;
    ...
    <div id={styles.scrollControl} className={styles.main}>
      <form onSubmit={onSubmit}>
        <div className={styles.rowflex}>
          ...
          <div className={styles.mainInput}>
            <div className={styles.title}>Service Link</div>
            <input
              className={styles.inputContainer}
              name="link"
              value={data.link}
        ...
        <div className={styles.rowflex}>
          <div className={styles.mainInput}>
            <div className={styles.title}>Service Representation Image</div>
          ...
          <div className={styles.mainInput}>
            <div className={styles.title}>Charge for the service</div>
            <input
              className={styles.inputContainer}
              name="cost"
              value={data.cost}
        ...
        <div className={styles.NT}>Description of the service</div>
        <br />{" "}
        <textarea
          name="description"
